         ...
         //       File.Delete("RTSc-6.13_FT.txt");
                ...
                try
                {
                    ...
                    do
                    {
                        ...
                        SmartServer.connect("82.204.220.34", 8090, "BPXXXXX", "FastProfitXXX");   /* connect to server */
                    }
     ...
     if (SmartServer.IsConnected())     //proceed
                {
                   ...
                   //     current thread is going to detect time xx.00.00                                                          
                        ...
                        while (true)
                        {
                            ...
                            if (DateTime.Now.Minute == 2 /*(60 - 5 * deltaDef) */ && DateTime.Now.Second == 00)                                                        
                            {
                ...
                Console.WriteLine(InfoBars.Last().ToString());
                ...
                else if (currBar == 0)  //last bar, need to assign o1 and c1
                     {
                        ...
                        // for any given bar we will have either sell or buy
                         ...
                         if (o1_value - c1_value > -1000 && o0_value - c1_value >= 20)
                         {
                             //open buy order and close at end of current bar                                             

                               SmartServer.PlaceOrder("BP12829-MS-01", 
                                                      "RTS-6.13_FT",
                    ...
                    else if (c1_value - o1_value > -1000 && c1_value - o0_value >= 20)
                         {
...
///////////////////////////////////////////////////////////////////////////
        ...
        { 
            ...
            while (true)
            {
                ...
                if (DateTime.Now.Minute == 59 /*(5 * deltaDef2 - 1)*/ && DateTime.Now.Second == 59 || 
                    DateTime.Now.Hour == 18 && DateTime.Now.Minute == 44 /*(44 + deltaClose)*/ && DateTime.Now.Second == 59)
                {
